...
public class SignupOne extends JFrame implements ActionListener{
    ...
    JDateChooser dateChooser;
     ...
     SignupOne() {
         ...
         Long random=Math.abs((ran.nextLong() % 9000L)+1000L);//rastgele sayı
         
         JLabel formno=new JLabel("BAŞVURU FORM NO. " + random);
         formno.setFont(new Font("Raleway",Font.BOLD,38));
         formno.setBounds(140,20,600,40);
         add(formno);
         
         JLabel personDetails=new JLabel("Sayfa 1: Kişisel Detaylar" );
         ...
         JLabel fname=new JLabel("Baba Adı:");
        ...
        add(dateChooser);
         ...
         male=new JRadioButton("Kadın");
         male.setBounds(300,290,60,30);
         male.setBackground(Color.WHITE);
         add(male);
         
         female=new JRadioButton("Erkek");
         ...
         gendergroup.add(female);//grup yapınca birini seçince öbürü iptal oluyo
         ...
         JLabel marital=new JLabel("Medeni Hal:");
         marital.setFont(new Font("Raleway",Font.BOLD,20));
         marital.setBounds(100,390,150,30);
         add(marital);
         
         married=new JRadioButton("Evli");
         married.setBounds(300,390,100,30);
         married.setBackground(Color.WHITE);
         add(married);
         
         unmarried=new JRadioButton("Bekar");
         unmarried.setBounds(450,390,120,30);
         unmarried.setBackground(Color.WHITE);
         add(unmarried);
         
         other=new JRadioButton("Diğer");
         ...
         JLabel address=new JLabel("İkametgah:");
         ...
         JLabel city=new JLabel("Doğum yeri:");
         ...
         JLabel pincode=new JLabel("Pin Kodu:");
     ...
     public void actionPerformed(ActionEvent ae){//şu event varya şu event
         ...
         try{
             if(name.equals("")){
                 JOptionPane.showMessageDialog(null, "İsim gerekli");
             }else{
                 Conn c=new Conn();
